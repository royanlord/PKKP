...
public class frmLolosFinal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tblLolosFinal.getColumnModel().getColumnCount() > 0) {
            tblLolosFinal.getColumnModel().getColumn(0).setHeaderValue("Kode Peserta");
            tblLolosFinal.getColumnModel().getColumn(1).setHeaderValue("Nama Peserta");
            tblLolosFinal.getColumnModel().getColumn(2).setHeaderValue("Jenis Kelamin");
            tblLolosFinal.getColumnModel().getColumn(3).setHeaderValue("Kabupaten/Kota");
        }
